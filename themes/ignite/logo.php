...
if ( get_theme_mod( 'logo_upload') ) {
    $logo = "<span class='screen-reader-text'>" . get_bloginfo('name') . "</span><img id='logo' class='logo' src='".esc_url('/wp-content/uploads/2015/09/tyolab-100.png'/*get_theme_mod( 'logo_upload')*/)."' alt='".esc_attr( get_bloginfo( 'name' ) )."' />";
} else {
